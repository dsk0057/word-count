...
public final class Main {
   ...
   * <p>This method assumes that a text file named {@code hound-of-the-baskervilles.txt} is
   * located on the classpath; otherwise (or if that file cannot be read for some reason),
   * an instance of {@link IOException} is thrown.</p>
   *
  ...
  public static void main(String[] args) throws IOException {
    ...
    try (
      ...
      while ((line = buffer.readLine()) != null) {
        //DONE Pass line to a method of WordCounter.
        counter.add(line);
      }
